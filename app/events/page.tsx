            ...
            {filteredEvents.map((event, idx) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed mb-4">{event.tagline}</p>
                  ...
                  <div className="mt-4 flex flex-wrap gap-1">
                    {event.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-slate-800 px-2.5 py-0.5 text-[10px] text-slate-300 font-mono"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      >
        {activeModalEvent && (
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">{activeModalEvent.description}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs bg-slate-800/60 p-4 rounded-xl border border-white/10">
              ...
              <div>
                <span className="text-slate-400 block">Location / Format</span>
