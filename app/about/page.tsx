...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen pt-20">
      ...
      {/* Full About GDG RMKEC Section */}
      <AboutSection />

      <div className="pb-24 relative overflow-hidden bg-[#0B0F17]">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 pt-10">
          {/* 4 Pillars Grid (Focus Areas) */}
          <div className="mb-24">
            <SectionHeader
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pillars.map((pillar, idx) => (
                <FadeIn key={pillar.title} delay={idx * 0.1}>
                  <div className="h-full rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur-xl hover:border-blue-500/40 transition-all duration-300 group">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-800 border border-white/10 group-hover:scale-110 transition-transform mb-4">
                      {pillar.icon}
                    </div>
          ...
          {/* Chapter Story Section (Community Impact) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24 rounded-3xl border border-white/10 bg-slate-900/70 p-8 sm:p-12 backdrop-blur-2xl">
