...
const impactStats = [
  {
    value: '653',
    label: 'Registered Hackathon Participants',
    subtext: 'Across RMK Group of Institutions in HackNEXA \'26',
    icon: <Users className="h-6 w-6 text-[#4285F4]" />,
    color: '#4285F4',
  },
  {
    value: '257',
    label: 'Hackathon Teams (114 Submissions)',
    subtext: '55 shortlisted teams evaluated across 2 floors of ECE labs',
  ...
  },
  {
    ...
    subtext: 'Hands-on Agentic AI & Google Cloud Jams',
    icon: <BookOpen className="h-6 w-6 text-[#FBBC05]" />,
    color: '#FBBC05',
  },
  {
    value: '40+',
    label: 'Certified Google Cloud Completers',
    subtext: 'Official milestone certified students felicitated by Principal',
    icon: <Cloud className="h-6 w-6 text-[#34A853]" />,
    color: '#34A853',
  },
  {
    value: '15+',
    label: 'AI Collage Project Pitches',
    subtext: 'Presented in A.C.E Day Batches 1 & 2 via Google Meet',
    icon: <Code2 className="h-6 w-6 text-[#4285F4]" />,
    color: '#4285F4',
  },
  {
    value: 'Top 3',
    label: 'Google Awarded Winners',
    subtext: 'Mavericks (Gold), Outliers (Silver), G.O.A.T (Bronze)',
